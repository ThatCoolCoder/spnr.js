...
if (window.spnr !== undefined) {
    ...
    // This doesn't look like it should work (spnr is not defined yet in this file)...
    // ...but it will because spnr has already been defined (that's why we're warning the user!)
    spnr.internalWarn('An instance of spnr.js is already running');
}
else {
...
spnr.GameEngine.DrawableEntity = class extends spnr.GameEngine.Entity {
    ...
    removeFromContainingScene() {
        if (this.containingScene != null) {
            ...
            this.removeChildrenFromContainingScene();
            spnr.arr.removeItem(this.scene.flattenedChildList, this);
        }
        this.containingScene = null;
    }
